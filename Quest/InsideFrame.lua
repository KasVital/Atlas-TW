...
local finishedQuestCheckbox = CreateFrame("CheckButton", "KQFinishedQuest", KQuestInsideFrame, "OptionsCheckButtonTemplate")
...
local questName = KQuestInsideFrame:CreateFontString("QuestName", "BACKGROUND", "GameFontNormal")
questName:SetWidth(400)
questName:SetHeight(12)
questName:SetPoint("TOP", 0, -20)

local questLevelText = KQuestInsideFrame:CreateFontString("QuestLeveltext", "BACKGROUND", "GameFontNormal")
...
local questAttainLevelText = KQuestInsideFrame:CreateFontString("QuestAttainLeveltext", "BACKGROUND", "GameFontNormal")
...
local prerequisiteText = KQuestInsideFrame:CreateFontString("Prequesttext", "BACKGROUND", "GameFontNormal")
...
local storyText = KQuestInsideFrame:CreateFontString("StoryTEXT", "BACKGROUND", "GameFontNormal")
...
local rewardsText = KQuestInsideFrame:CreateFontString("REWARDstext", "BACKGROUND", "GameFontNormal")
...
local finishedQuestText = KQuestInsideFrame:CreateFontString("KQFinishedQuestText", "BACKGROUND", "GameFontNormal")
...
finishedQuestText:SetText(AQQuestFinished)

local pageCountText = KQuestInsideFrame:CreateFontString("AQPageCount", "BACKGROUND", "GameFontNormal")
...
-- Set text properly for template buttons in WoW 1.12
getglobal("CLOSEbutton3Text"):SetText("Quests")

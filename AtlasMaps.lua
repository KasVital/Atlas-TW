...
-- Turtle WOW
	...
	KinTozo = {
		ZoneName = { "Kin'Tozo", NPC, 80269 },
		Location = { BZ["Stranglethorn Vale"], ZONE, 0 },
		LevelRange = "45",
		Health = "19988",
		Mana = "-",
		{ GREY.."1) ".."Kin'Tozo", NPC, 80269 },
	},
	MargontheMighty = {
		ZoneName = { "Margon the Mighty", NPC, 91839 },
		Location = { BZ["Lapidis Isle"], ZONE, 0 },
		LevelRange = "55",
		Health = "24877",
		Mana = "-",
		{ GREY.."1) ".."Margon the Mighty", NPC, 91839 },
	},
	ProfessorLysander = {
		ZoneName = { "Professor Lysander", NPC, 61853 },
		Location = { BZ["Western Plaguelands"], ZONE, 0 },
		LevelRange = "59",
		Health = "8883",
		Mana = "?",
		{ GREY.."1) ".."Professor Lysander", NPC, 61853 },
	},
	Other = {
		ZoneName = { "Other", NPC, 0	},
		Location = { "Various locations", ZONE, 0 },
		LevelRange = "16-55",
		Health = "Various",
		Mana = "Various",
		{ GREY.."1) ".."Shade Mage".._RED.." (17) "..WHIT..BZ["Tirisfal Glades"]..ORNG.." [15, 68]", NPC, 61499 },
		{ GREY.."2) ".."Graypaw Alpha".._RED.." (18) "..WHIT..BZ["Tirisfal Glades"]..ORNG.." [27, 58]", NPC, 91990 },
		{ GREY.."3) ".."Earthcaller Rezengal".._RED.." (18) "..WHIT..BZ["Stonetalon Mountains"]..ORNG.." [74, 79]", NPC, 61504 },
		{ GREY.."4) ".."Blazespark".._RED.." (24) "..WHIT..BZ["Stonetalon Mountains"]..ORNG.." [21, 29]", NPC, 61503 },
		{ GREY.."5) ".."Witch Doctor Tan'zo".._RED.." (35) "..WHIT..BZ["Arathi Highlands"]..ORNG.." [44, 13]", NPC, 61502 },
		{ GREY.."6) ".."Dawnhowl".._RED.." (40) "..WHIT..BZ["Gilneas"]..ORNG.." [43, 23]", NPC, 61554 },
		{ GREY.."7) ".."Widow of the Woods".._RED.." (40) "..WHIT..BZ["Gilneas"]..ORNG.." [30, 50]", NPC, 61553 },
		{ GREY.."8) ".."Maltimor's Prototype".._RED.." (43) "..WHIT..BZ["Gilneas"]..ORNG.." [48, 57]", NPC, 61551 },
		{ GREY.."9) ".."Bonecruncher".._RED.." (44) "..WHIT..BZ["Gilneas"]..ORNG.." [54, 56]", NPC, 61555 },	
		{ GREY.."10) ".."Duskskitterer".._RED.." (44) "..WHIT..BZ["Gilneas"]..ORNG.." [46, 78]", NPC, 61552 },
		{ GREY.."11) ".."Baron Perenolde".._RED.." (45) "..WHIT..BZ["Gilneas"]..ORNG.." [67, 80]", NPC, 61550 },
		{ GREY.."12) ".."M-0L1Y".._RED.." (47) "..WHIT..BZ["Icepoint Rock"]..ORNG.." [54, 40]", NPC, 61498 },
		{ GREY.."13) ".."Ripjaw".._RED.." (51) "..WHIT..BZ["Lapidis Isle"]..ORNG.." [55, 21]", NPC, 61515 },
		{ GREY.."14) ".."Ruk'thok the Pyromancer".._RED.." (51) "..WHIT..BZ["Lapidis Isle"]..ORNG.." [43, 29]", NPC, 61517 },
		{ GREY.."15) ".."Embereye".._RED.." (51) "..WHIT..BZ["Gillijim's Isle"]..ORNG.." [67, 69]", NPC, 61516 },
		{ GREY.."16) ".."Firstborn of Arugal".._RED.." (55) "..WHIT..BZ["Gilneas"]..ORNG.." [40, 37]", NPC, 61558 },
		{ GREY.."17) ".."Aquitus".._RED.." (56) "..WHIT..BZ["Gillijim's Isle"]..ORNG.." [27, 70]", NPC, 61518 },
		{ GREY.."18) ".."Stoneshell".._RED.." (56) "..WHIT..BZ["Tel'Abim"]..ORNG.." [40, 47]", NPC, 61501 },
		{ GREY.."19) ".."Highvale Silverback".._RED.." (58) "..WHIT..BZ["Tel'Abim"]..ORNG.." [57, 48]", NPC, 61500 },
		{ GREY.."20) ".."Azurebeak".._RED.." (60) "..WHIT..BZ["Hyjal"]..ORNG.." [23, 37]", NPC, 61488 },
		{ GREY.."21) ".."Barkskin Fisher".._RED.." (60) "..WHIT..BZ["Hyjal"]..ORNG.." [66, 53]", NPC, 61487 },
		{ GREY.."22) ".."Shadeflayer Goliath".._RED.." (61) "..WHIT..BZ["Hyjal"]..ORNG.." [10, 44]", NPC, 61533 },
	--	{ GREY.."12) ".."Kin'Tozo".._RED.." (45) "..WHIT..BZ["Stranglethorn Vale"]..ORNG.." [27, 55]", NPC, 80269 },
	--	{ GREY.."18) ".."Margon the Mighty".._RED.." (55) "..WHIT..BZ["Lapidis Isle"]..ORNG.." [30, 41]", NPC, 91839 },
	--	{ GREY.."22) ".."Professor Lysander".._RED.." (59) "..WHIT..BZ["Western Plaguelands"]..ORNG.." [12, 50]", NPC, 61853 },
	},
	Kargron = {
	...
	Letashaz = {
		ZoneName = { "Letashaz", NPC, 92163	},
		Location = { BZ["Gillijim's Isle"], ZONE, 1 },
		LevelRange = "55",
		Health = "25235",
		Mana = "-",
		{ GREY.."1) ".."Letashaz", NPC, 92163 },
	},
	Ashbeard = {
